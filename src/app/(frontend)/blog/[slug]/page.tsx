    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      <section className="site-containers pt-32 pb-12 relative z-10">
        ...
        <div className="mb-8">
          <Link
            href="/blog"
            className="inline-flex items-center text-sm font-sans text-gray-500 hover:text-[#D02030] transition-colors"
          >
        ...
        <div className="mx-auto text-center mb-12">
          ...
          <p className="text-[16px] font-sans text-black mx-auto">
            Stay connected with us by subscribing to our blog updates, by doing so, you&apos;ll
            receive notifications whenever we publish new articles.
          </p>
        </div>
        ...
        <div className="relative aspect-video w-full rounded-[4px] overflow-hidden shadow-lg">
          {post.heroImage && (
            <Media resource={post.heroImage} fill className="object-cover" priority />
          )}
        </div>
      </section>
        ...
        <div className="site-containers">
          ...
          >
            ...
            {post.meta?.description && (
              <div className="mb-10">
                <h1 className="text-[32px] md:text-[40px] font-cal text-black mb-6">
                  Introduction
                </h1>
                {post.meta.description && (
                  <p className="text-[18px] md:text-[19px] font-normal leading-relaxed text-black mb-10">
                    {post.meta.description}
                  </p>
                )}
              </div>
