...
export default function Header() {
  ...
  return (
    <header
      className={`absolute top-0 left-0 w-full z-50 border-b ${isLightPage ? 'border-gray-100' : 'border-white/10'}`}
    >
        ...
        <div className="flex items-center gap-12">
          ...
          {showMenu && (
            <div className="hidden md:flex items-center space-x-8 text-black/90 font-medium">
              ...
              <Link href="/solutions" className="hover:text-[#D02030] transition-colors">
                Solutions
              </Link>
              <Link href="/blog" className="hover:text-[#D02030] transition-colors">
                Blog
              </Link>
              <Link href="/about" className="hover:text-[#D02030] transition-colors">
                About
              </Link>
            </div>
          )}
