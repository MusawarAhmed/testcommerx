        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
          ...
          <div className="space-y-8 max-w-xs">
            ...
            <div className="space-y-4 font-sans text-[12px] font-normal text-white/70">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@commerx.com" className="hover:text-white transition-colors">
                  info@commerx.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <PhoneIcon color="#ffffff" className="w-3 h-3" />
                <a href="tel:1-833-301-3883" className="hover:text-white transition-colors">
                  1-833-301-3883
                </a>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-20 lg:gap-32">
            ...
            <div className="space-y-6">
              <h4 className="font-cal text-[12px] font-normal uppercase tracking-wider text-white">
                Quick Links
              </h4>
