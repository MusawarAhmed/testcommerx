...
const marketingMockData = [
  {
    ...
    title: '',
    titleAccent: '',
    tags: ['Brand Strategy', 'Positioning & Messaging', 'Visual Identity', 'Brand Guidelines', 'Creative Production', 'Sales & Marketing Collateral'],
    descriptionHeading: 'Build A Cohesive Brand System That Earns Trust And Drives Preference.',
    description: 'At Strategic Business Solutions, we specialize in crafting business strategies that go beyond mere plans. They are blueprints for growth, innovation, solution and enduring compassing that prosperity.',
  ...
  },
  {
    ...
    title: '',
    titleAccent: '',
    tags: ['Campaign Strategy & Management', 'Search Advertising', 'Paid Social Advertising', 'Display & Retargeting', 'Conversion Tracking & Analytics', 'Performance Reporting & Optimization'],
    descriptionHeading: 'Performance-Driven Campaigns Optimized For Measurable ROI.',
    description: 'We engineer data-backed paid strategies—across search, social, and display—specifically designed to capture high-intent traffic and convert it into a predictable pipeline of qualified leads.',
  ...
  },
  {
    ...
    title: '',
    titleAccent: '',
    tags: ['SEO Strategy', 'Technical SEO', 'On-Page Optimization', 'Content Strategy', 'Content Production', 'Content Optimization & Reporting'],
    descriptionHeading: 'Establish Industry Dominance Through Strategic Authority.',
    description: 'Position your brand as a trusted voice in your category—driving sustained inbound demand and supporting conversion throughout the buyer journey.',
  ...
  },
  {
    ...
    title: '',
    titleAccent: '',
    tags: ['Website Strategy', 'UI / UX Design', 'Website & Landing Pages', 'Conversion Rate Optimization (CRO)', 'Website Content & Copy', 'Performance & Analytics Setup'],
    descriptionHeading: 'Accelerate Growth With Data-Driven Strategy, Creative Design, And Performance Marketing.',
    description: 'At Strategic Business Solutions, we specialize in crafting business strategies that go beyond mere plans. They are blueprints for growth, innovation, solution and enduring compassing that prosperity.',
  ...
  },
  {
    ...
    title: '',
    titleAccent: '',
    tags: ['Lead Generation Strategy', 'Prospecting & List Building', 'Email Outreach Campaigns', 'LinkedIn Outreach Campaigns', 'Appointment Setting', 'Lead Gen Reporting & Optimization'],
