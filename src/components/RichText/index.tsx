...
import { QuoteBlockComponent, type QuoteBlockProps } from '@/blocks/QuoteBlock/Component'
import {
  DefaultNodeTypes,
  SerializedBlockNode,
  SerializedLinkNode,
...
type NodeTypes =
  | DefaultNodeTypes
  | SerializedBlockNode<MediaBlockProps | BannerBlockProps | CodeBlockProps | QuoteBlockProps>
...
const jsxConverters: (author?: {
  ...
  ({ defaultConverters }) => ({
    ...
    blocks: {
      ...
      quoteBlock: ({ node }) => <QuoteBlockComponent {...node.fields} />,
    },
  })
