  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="site-containers relative z-10">
        {heading && (
          <h2 className="text-center text-[32px] md:text-[48px] font-bold text-white mb-16">{heading}</h2>
        )}

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {cards?.map((card, index) => (
            <div key={index} className="bg-white rounded-xl p-10 transition-transform hover:-translate-y-1 shadow-lg">
