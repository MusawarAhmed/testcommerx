...
import type { PathwaySectionBlock } from '@/payload-types'

export const PathwaySectionComponent: React.FC<PathwaySectionBlock> = (props) => {
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24 items-center">
        ...
        <div className="space-y-8 z-10">
          <h2 className="text-[32px] md:text-[56px] font-cal text-black leading-[1.1]">
            {title ? (
              title.includes('<br>') || title.includes(' <br') ? (
            ...
            {steps && steps.length > 0
              ? steps.map((step, index) => (
                  ...
                  >
                    ...
                    >
                      <div className="bg-[#F3F6FD] p-6 rounded-[12px] min-w-[200px]">
